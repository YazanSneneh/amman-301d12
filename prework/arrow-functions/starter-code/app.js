...
// You may also be familiar with function declarations,
// which begin with the "function" keyword.
...
//   the windows object itself.
// 2. What is "this" when joe.scopeArrow() is invoked?
//   the windows object
// 3. Explain why "this" is different when an arrow function is used.
//    this keyword in regular function refer to object that called it, which means when i use 
// this keyword with regular function and call it, it will output windows object. And if
// i use this inside a method, it will output the object that contain the method.
// In arrow functions, no matter where the function called, still gonna output the object where
// arrow function was declared.  Like step 11
